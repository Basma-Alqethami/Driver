...
class ChangeMapViewController:UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
...
extension ChangeMapViewController : UISearchBarDelegate {
...
extension ChangeMapViewController : UITableViewDelegate, UITableViewDataSource{
    ...
    func dropPinZoomIn(placemark:MKPlacemark){
        ...
        let vc = self.storyboard?.instantiateViewController(withIdentifier: "ChangeView") as! ChangeViewController
